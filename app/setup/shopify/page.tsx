...
export default function ShopifySetupPage() {
  ...
  const shopifySteps: Array<{
    ...
    },
    {
      ...
      content: [
        ...
        <span key="37">
          ...
          and don't hesitate to restart a conversation if you feel it's stuck in
          a loop. You can also references a previous conversation in the prompt
    ...
    },
    {
      ...
      content: [
        "Do not mix your experimentations with the Shopify codebase, e.i. do not save anything within the World or B3 folder if you have them.",
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-2 sm:gap-3">
            {shopifySteps.map((step, index) => {
              ...
              return (
                ...
                >
                  <Card
                    className={`h-full border-0 rounded-3xl shadow-sm hover:shadow-lg transition-all overflow-hidden cursor-pointer !py-0 ${
                      isCompleted ? "frosted-glass-blue" : "bg-white"
                    }`}
                  ...
                  >
                    <div className="p-6 sm:p-8 h-full flex flex-col relative">
                      ...
                      <h3
                        className={`text-2xl sm:text-3xl font-light mb-3 sm:mb-4 ${
                      ...
                      <p
                        className={`text-sm sm:text-base mb-4 sm:mb-6 ${
                          isCompleted ? "text-white/90" : "text-black"
                        }`}
                      >
                        {step.description}
                      </p>
                      ...
                      {/* Bullet list */}
                      <ul
                        className={`space-y-2 text-s sm:text-m flex-grow mb-12 ${
                          isCompleted ? "text-white/80" : "text-black"
                        }`}
                      >
